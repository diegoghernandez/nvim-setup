    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        if package.loaded['fzf-lua'] then
          map('grd', '<cmd>FzfLua lsp_definitions jump1 ignore_current_line=true<cr>', 'Goto Definition')
          ...
          map('gry', '<cmd>FzfLua lsp_typedefs jump1 ignore_current_line=true<cr>', 'Goto T[y]pe Definition')
